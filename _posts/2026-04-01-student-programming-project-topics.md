...
description: "高中生資訊類自主學習題目選擇與規劃：遊戲開發、網路應用、人工智慧、跨領域整合、升學導向五大類型，含挑題原則、function list 拆解、每週時程表與常見錯誤。"
categories: [資訊教學,自主學習]
tags: [程式設計, APCS, 資訊自主學習, 高中自主學習]
---
💡 資訊類自主學習題目規劃重點

這篇文章整理高中生資訊自主學習的五大型別（遊戲、網路、AI、跨領域、升學導向），並教怎麼挑題目、拆功能清單與排每週時程。
...
五大類：遊戲開發（俄羅斯方塊、卡牌、益智遊戲）、網路應用（部落格、任務管理、天氣查詢）、人工智慧（影像辨識、聊天機器人、推薦系統）、跨領域整合（智慧家居、環境監測、視障導航）、升學導向（準備 APCS）。

### 自主學習題目要怎麼選？

兩個核心原則：從生活中找困擾（拿張紙寫下三個日常最困擾的事，想程式如何解決）、誠實評估能力與時間（選「略高於現有能力」的難度，太簡單無聊、太難容易放棄）。

### 決定題目後該怎麼規劃？

先搞定開發環境（Python/Node.js/JDK 安裝與 Hello World）；再拆解 function list（把大題目拆成獨立功能模組，例如訂餐系統拆成登入、菜單、購物車、訂單、付款、後台）；最後訂每週進度並固定檢核。

### 自主學習的 15 週時程怎麼排？

第1-2週規劃（確認題目/功能清單）、3-4週環境建置、5-10週功能開發、11-12週功能整合除錯、13-14週做簡報/海報、15週成果展示；週數可視學校進度調整。

### 用 AI 做自主學習會不會學不到東西？

AI 是助手不是替代品：可以請 AI 寫程式，但自己要能理解程式碼在做什麼、會讀錯誤訊息、能判斷建議是否合理；避免只複製貼上不求甚解。
